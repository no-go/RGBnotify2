...
//  0x20,     // --set start line address
  0x40,     // --set start line address ORG

  0x81, 0xFF,   // Set contrast control register
//  0x81, 0x3F,   // Set contrast control register ORG

	0xA1,			// Set Segment Re-map. A0=address mapped; A1=address 127 mapped. 
	0xA6,			// Set display mode. A6=Normal; A7=Inverse

//  0xA8, 0x3F,   // Set multiplex ratio(1 to 64) SSD1306_LCDHEIGHT - 1 ORG
  0xA8, 0x1F,   // Set multiplex ratio(1 to 64) SSD1306_LCDHEIGHT - 1
...
//  0xDA, 0x12,   // Set com pins hardware configuration   ORG 
...
void ssd1306_fill4(uint8_t p1, uint8_t p2, uint8_t p3, uint8_t p4) {
	ssd1306_setpos(0, 0);
	ssd1306_send_data_start();
  for (uint16_t i = 0; i < 128 * 8 / 4; i++) { // ORG
//  for (uint16_t i = 0; i < 64 * 8 / 4; i++) {
    // 4 Byte = 32 pixel
